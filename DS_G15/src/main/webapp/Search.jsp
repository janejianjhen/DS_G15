...
<div class='note'>
<img src="pic_1.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note1'>
<img src="pic_2.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note2'>
<img src="pic_3.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div>
<div class='note3'>
<img src="pic_4.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div>  
<div>
<input type='text' class="border-style" id="padding"  
style='font-size:120%;position:absolute;left:50%;top:48%;
margin-top:-47px;margin-left:-400px;width:700px;height:45px' name='keyword' placeholder='請輸入關鍵字'
onfocus="placeholder= '' " onblur="placeholder='請輸入關鍵字'" />

<input type='text' class="filter-style" id="padding_2" name='filter'
style='font-size: 120%; position: absolute; left: 50.5%; top: 83%; margin-top: -250px; margin-left: -400px; width: 700px; height: 25px' placeholder = '請輸入過濾字' 
onfocus="placeholder= '' " onblur="placeholder=' 請輸入過濾字'" />
</div>
...
style='position:absolute;width:37px;height:37px;left:43%;top:50%;margin-top:-55px;
margin-left:368px '/>
</div>

<div>
<a href ='http://localhost:8005/DS_G15_1/Website'><img src="BTS_1.png" style='position:absolute;width:350px;height:150px;left:48%;top:50%;margin-top:-265px;
margin-left:-175px '></a>
</div>
</form>
</body>
